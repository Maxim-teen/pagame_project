    ...
    def load_user_data(self, username):
        try:
            with open(WALLET_FILE, 'r') as file:
                ...
                for row in reader:
                    if row[0] == username:
                        self.best_score = int(row[3])  # Load best score
                        return
    ...
    def update_user_score(self, username, new_score):
        try:
            ...
            with open(WALLET_FILE, 'r') as file:
                ...
                for row in reader:
                    if row[0] == username:
                        row[3] = str(new_score)  # Update best score
                    rows.append(row)
    ...
    def register_user(self, username, password):
        try:
            ...
            with open(WALLET_FILE, 'a', newline='') as file:
                writer = csv.writer(file)
                writer.writerow([username, 0, password, 0])  # balance and score initialized to 0
